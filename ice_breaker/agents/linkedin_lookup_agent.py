...
def linkedin_lookup_agent(name: str) -> str:
    ...
    template = """
        given the full name and some additional information {name_of_person} I want you to get it me a link to their Linkedin profile page.
        IMPORTANT: Your answer should contain only the URL of the Linkedin profile page and nothing more.
        Response format: <linkedin-profile-url>
    ...
    tools_for_agent = [
        Tool(
            ...
            description="Useful for when you need get the Linkedin Page URL" # description is the field used to the agent determine if the tool is useful for the task
